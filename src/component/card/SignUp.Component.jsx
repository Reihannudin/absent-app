                ...
                <div>
                    ...
                    <div className="text-left">
                        <div className="my-8">
                            ...
                            <input type="email"  onChange={onChangeEmail} value={email} className="w-full py-3 border-b-gray-300"  style={{ borderBottom:"1px solid #ebebeb"}} placeholder="your@email.com"/>
                        </div>
                        <div className="py-24">
                        </div>
