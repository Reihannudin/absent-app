        ...
        <div className="bg-white w-full my-6 border-radius-8 shadow">
            <div className="w-full  flex">
                ...
                <div className="md:w-7/12 w-8/12  flex">
                    <div className="w-5/12 py-3  text-left">
                        <h3 style={{ fontSize:"14px"}}>Class</h3>
                        <h3 style={{ fontSize:"14px"}}>Teacher</h3>
                    </div>
                    <div className="w-5/12 py-3  text-left">
                        <h3 style={{ fontSize:"14px"}}>Status</h3>
                        <h3 style={{ fontSize:"14px"}}>Absent time</h3>
                    </div>
                    <div className="lg:w-4/12 w-3/12 text-right lg:mx-5 mx-2">
                        <button id="btn_pop_up_detail" onClick={popUpDetail} className="weverse-background-btn py-2 my-3 border-radius-8 text-white lg:w-10/12 w-full" style={{ fontSize:"14px"}}>Detail</button>
                    </div>
                </div>
            </div>
        </div>
        <div id="pop_up_detail" tabIndex="-1" style={{ display:"none" , background:"rgba(75,75,75,0.67)" }} className="fixed z-50 w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] md:h-full">
            <div className="absolute w-6/12 mx-auto h-full max-w-2xl md:h-auto" style={{ left:"33%"}}>
                <div className="relative bg-white w-8/12 top-16 rounded-lg shadow dark:bg-gray-700" style={{ height:"350px"}} >
                    <div className="flex items-start justify-end pt-7 pb-5 px-4 border-b rounded-t dark:border-gray-600">
                        <h3 className="text-xl  w-full ms-5 font-semibold text-center text-gray-900 dark:text-white">
                            Detail Absent
                        </h3>
