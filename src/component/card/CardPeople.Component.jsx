            ...
            <div className="bg-white w-full my-6 border-radius-8 shadow">
                <div className="w-full justify-between flex">
                    ...
                    <div className="w-5/12 text-right mx-5">
                        <button id="btn_pop_up_detail" onClick={popUpDetail} className="weverse-background-btn py-1.5 my-3 border-radius-8 text-white w-7/12" style={{ fontSize:"14px"}}>Detail</button>
                    </div>
                </div>
            </div>
