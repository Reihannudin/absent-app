                ...
                <header className="w-10/12  mx-auto">
                    <div className="flex py-1 justify-between gap-4">
                        ...
                        <div className="flex">
                            ...
                            <div className="px-4 my-auto text-gray-800 font-normal ">
                                {myClass.map((itemClass)=> {
                                    return(
                                        <>
                                        <div>
                                            <a href={`/my/class/create/absent/${id}?classesId=${itemClass.id}&vocationId=${itemClass.vocation_id}`}>
                                                <div className="shadow weverse-background-btn py-2 px-2 text-white " style={{ borderRadius:"4px"}}>
                                                    Create Absent
                                                </div>
                                            </a>
                                        </div>
